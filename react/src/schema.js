...
fields: () => ({
  ...
  accountProfile: {
    ...
    description: "Private Account and ID Details that individual can create/access/edit"
  },
  coreProfile: {
    type: new GraphQLObjectType({
      name: 'coreProfile',
    ...
    description: "Private and/or Public and sharable details, editable by individual"
  },
  roleProfiles: {
    type: new GraphQLList(prifinaRoleProfileType),
    description: "Private and/or Public and sharable details, editable by individual"
  },
  activityData: {
    type: new GraphQLObjectType({
...
const prifinaRoleSocialType = new GraphQLObjectType({
  name: 'prifinaRoleSocial',
  description: '',
  fields: () => ({
    contacts: {
...
const prifinaRoleEducationType = new GraphQLObjectType({
  name: 'prifinaRoleEducation',
  description: '',
  fields: () => ({
    educationLevel: {
      type: new GraphQLEnumType({
        name: 'prifinaRoleEducationLevelEnum',
        description: '',
        values: {
          "Unknown": {
            value: 0,
    ...
    certificates: {
      type: new GraphQLList(prifinaRoleCertificateType),
      description: ""
    },
    grades: {
      type: new GraphQLList(new GraphQLObjectType({
        name: 'prifinaRoleEducationGradeType',
        description: '',
        fields: () => ({
          subject: {
            type: GraphQLString,
          ...
          type: {
            type: new GraphQLEnumType({
              name: 'prifinaRoleEducationTypeEnum',
              description: '',
              values: {
                "GCSE": {
                  value: 0,
...
const prifinaRoleProfessionalType = new GraphQLObjectType({
  name: 'prifinaRoleProfessional',
  description: '',
  fields: () => ({
    employer: {
      type: new GraphQLList(prifinaCompanyUnion),
      description: ""
    },
    jobTitle: {
      type: GraphQLString,
    ...
    curriculumVitae: {
      type: new GraphQLObjectType({
        ...
        fields: () => ({
          ...
          links: {
            type: new GraphQLList(new GraphQLObjectType({
              name: 'prifinaCurriculumVitaeLink',
              description: '',
              fields: () => ({
                name: {
                  type: GraphQLString,
          ...
          workExperience: {
            type: new GraphQLList(new GraphQLObjectType({
              name: 'prifinaCurriculumVitaeWorkExperience',
              description: '',
              fields: () => ({
                startDate: {
                  type: GraphQLString,
          ...
          education: {
            type: new GraphQLList(new GraphQLObjectType({
              name: 'prifinaCurriculumVitaeEducation',
              description: '',
              fields: () => ({
                issuer: {
                  type: GraphQLString,
                ...
                result: {
                  type: prifinaDegreeGradeResult,
                  description: ""
                },
                results: {
                  type: new GraphQLList(new GraphQLObjectType({
                    name: 'prifinaCurriculumVitaeEducationResult',
                    description: '',
                    fields: () => ({
                      subject: {
                        type: GraphQLString,
          ...
          references: {
            type: new GraphQLList(new GraphQLObjectType({
              name: 'prifinaCurriculumVitaeReference',
              description: '',
              fields: () => ({
                name: {
                  type: GraphQLString,
...
const prifinaRoleProfileType = new GraphQLUnionType({
  name: 'prifinaRoleProfiles',
  types: [ prifinaRoleSocialType,prifinaRoleEducationType, prifinaRoleProfessionalType ]
  });
...
const prifinaCompanyUnion = new GraphQLUnionType({
  name: 'prifinaCompany',
  types: [ new GraphQLObjectType({
    name: 'prifinaCompanyName',
    description: '',
    fields: () => ({
      name:{
        type: GraphQLString,
  ...
  }), prifinaCompanyEntityType ]
  });

const prifinaGradeResultType = new GraphQLUnionType({
  name: 'prifinaGradeResult',
  types: [ new GraphQLObjectType({
      name: 'prifinaGradeUKNumberResult',
      description: '',
      fields: () => ({
        result: {
          type: new GraphQLEnumType({
            name: 'prifinaGradeUKNumberResultEnum',
            description: '',
            values: {
              "U": {
                value: 0,
      ...
      name: 'prifinaGradeUKLetterResult',
      description: '',
      fields: () => ({
        result: {
          type: new GraphQLEnumType({
            name: 'prifinaGradeUKLetterResultEnum',
            description: '',
            values: {
              "U": {
                value: 0,
      ...
      name: 'prifinaGradeUSALetterResult',
      description: '',
      fields: () => ({
        result: {
          type: new GraphQLEnumType({
            name: 'prifinaGradeUSALetterResultEnum',
            description: '',
            values: {
              "A_plus": {
                value: 13,
  ...
  const prifinaDegreeGradeResult = new GraphQLUnionType({
    name: 'prifinaDegreeGradeResult',
    types: [ new GraphQLObjectType({
        name: 'prifinaDegreeGradePercentResult',
        description: '',
        fields: () => ({
          result: {
            type: GraphQLInt,
        ...
        name: 'prifinaDegreeGradeUKLetterResult',
        description: '',
        fields: () => ({
          result: {
            type: new GraphQLEnumType({
              name: 'prifinaDegreeGradeUKLetterResultEnum',
              description: '',
              values: {
                "Failed": {
                  value: 0,
                ...
                "First": {
                  value: 4,
                  description: 'First Class Honours (1st)',
                },
                "Second_Upper": {
                  value: 3,
                  description: 'Second Class Honours - Upper division (2:1)',
                },
                "Second_Lower": {
                  value: 2,
                  description: 'Second Class Honours - Lower division (2:2)',
                },
                "Third": {
                  value: 1,
                  description: 'Third Class Honours (3rd)',
                },
...
const prifinaRoleCertificateType = new GraphQLObjectType({
  name: 'prifinaRoleCertificateType',
  description: '',
  fields: () => ({
    title: {
      type: GraphQLString,
